...
import TabelaClientes from "../../components/tables/BasicTables/TabelaClientes";

export default function Clientes() {
  const navigate = useNavigate();
  return (
    <>
      <PageMeta title="Clientes" description="Listagem de Clientes" />
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          action={
            <button
              onClick={() => navigate("/clientes/cadastrar-cliente")}
