...
import TabelaUsuarios from "../../components/tables/BasicTables/TabelaUsuarios";

export default function Usuarios() {
  const navigate = useNavigate();
  return (
    <>
      <PageMeta title="Usuários" description="Listagem de Usuários" />
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          action={
            <button
              onClick={() => navigate("/usuarios/cadastrar-usuario")}
