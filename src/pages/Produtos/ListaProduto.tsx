...
import TabelaProduto from "../../components/tables/BasicTables/TabelaProduto";

export default function Produto() {
  const navigate = useNavigate();
  return (
    <>
      <PageMeta title="Produto" description="Listagem de Produto" />
      <PageBreadcrumb pageTitle="Produto" />
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          action={
            <button
              onClick={() => navigate("/produtos/cadastrar-produto")}
