...
export default function EditorFuncionario() {
  ...
  const [form, setForm] = useState(dadosFuncionario);
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2">
          <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Chave PIX</label>
          <input
            name="pix"
            value={form.pix}
            onChange={handleChange}
